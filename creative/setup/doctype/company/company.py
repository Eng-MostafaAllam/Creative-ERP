...
from creative.accounts.doctype.account.account import get_account_currency
from creative.setup.setup_wizard.operations.taxes_setup import setup_taxes_and_charges
...
def install_country_fixtures(company, country):
	try:
		module_name = f"creative.regional.{frappe.scrub(country)}.setup.setup"
