...
creative.maintenance.MaintenanceSchedule = class MaintenanceSchedule extends frappe.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new creative.maintenance.MaintenanceSchedule({frm: cur_frm}));
