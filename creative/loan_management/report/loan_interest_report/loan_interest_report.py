...
import creative
from creative.loan_management.report.applicant_wise_loan_security_exposure.applicant_wise_loan_security_exposure import (
...
def get_active_loan_details(filters):
	...
	currency = creative.get_company_currency(filters.get("company"))
