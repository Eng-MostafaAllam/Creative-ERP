...
# creative - web based ERP (http://creative.com)
...
from creative.stock.stock_balance import get_indented_qty, update_bin_qty
...
class MaterialRequest(BuyingController):
	...
	def validate(self):
		...
		from creative.controllers.status_updater import validate_status
