...
from creative.accounts.utils import get_balance_on
...
from creative.stock.doctype.delivery_note.delivery_note import (
	make_delivery_trip,
	make_sales_invoice,
)
from creative.stock.doctype.item.test_item import make_item
from creative.stock.doctype.purchase_receipt.test_purchase_receipt import get_gl_entries
from creative.stock.doctype.serial_no.serial_no import SerialNoWarehouseError, get_serial_nos
...
from creative.stock.stock_ledger import get_previous_sle
...
class TestDeliveryNote(FrappeTestCase):
	...
	def test_closed_delivery_note(self):
		from creative.stock.doctype.delivery_note.delivery_note import update_delivery_note_status
	...
	def test_dn_billing_status_case3(self):
		...
		from creative.selling.doctype.sales_order.sales_order import make_delivery_note
		from creative.selling.doctype.sales_order.sales_order import (
	...
	def test_dn_billing_status_case4(self):
		# SO -> SI -> DN
		from creative.accounts.doctype.sales_invoice.sales_invoice import make_delivery_note
		from creative.selling.doctype.sales_order.sales_order import make_sales_invoice
