...
import creative
from creative.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
...
def repost_gl_entries(doc):
	if not cint(creative.is_perpetual_inventory_enabled(doc.company)):
		return
