...
from creative.stock.doctype.item_price.item_price import ItemPriceDuplicateItem
from creative.stock.get_item_details import get_price_list_rate_for, process_args
...
class TestItemPrice(FrappeTestCase):
	...
	def test_addition_of_new_fields(self):
		# Based on https://github.com/frappe/creative/issues/8456
