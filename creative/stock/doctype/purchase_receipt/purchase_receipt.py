...
from creative.stock.doctype.delivery_note.delivery_note import make_inter_company_transaction
...
def make_purchase_invoice(source_name, target_doc=None):
	from creative.accounts.party import get_payment_terms_template
