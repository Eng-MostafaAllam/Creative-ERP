...
import creative
from creative.accounts.doctype.account.test_account import get_inventory_account
from creative.controllers.buying_controller import QtyMismatchError
from creative.stock.doctype.item.test_item import create_item, make_item
from creative.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice
from creative.stock.doctype.serial_no.serial_no import SerialNoDuplicateError, get_serial_nos
from creative.stock.doctype.warehouse.test_warehouse import create_warehouse
from creative.stock.stock_ledger import SerialNoExistsInFutureTransaction
...
class TestPurchaseReceipt(FrappeTestCase):
	...
	def test_purchase_receipt_no_gl_entry(self):
		from creative.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(creative.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_purchase_return_for_rejected_qty(self):
		from creative.stock.doctype.warehouse.test_warehouse import get_warehouse
	...
	def test_closed_purchase_receipt(self):
		from creative.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_pr_billing_status(self):
		...
		3. PO -> PR2.
		"""
		from creative.buying.doctype.purchase_order.purchase_order import (
		...
		from creative.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
	...
	def test_purchase_return_with_submitted_asset(self):
		from creative.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_return
	...
	def test_make_purchase_invoice_from_pr_for_returned_qty(self):
		from creative.buying.doctype.purchase_order.test_purchase_order import (
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from creative.buying.doctype.purchase_order import purchase_order, test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from creative.accounts.doctype.purchase_invoice.purchase_invoice import (
		...
		from creative.accounts.party import add_party_account
	...
	def test_payment_terms_are_fetched_when_creating_purchase_invoice(self):
		from creative.accounts.doctype.payment_entry.test_payment_entry import (
			create_payment_terms_template,
		)
		from creative.accounts.doctype.purchase_invoice.test_purchase_invoice import make_purchase_invoice
		from creative.buying.doctype.purchase_order.test_purchase_order import (
			create_purchase_order,
			make_pr_against_po,
		)
		from creative.selling.doctype.sales_order.test_sales_order import (
	...
	def test_neg_to_positive(self):
		from creative.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
	...
	def test_backdated_transaction_for_internal_transfer(self):
		from creative.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from creative.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_backdated_transaction_for_internal_transfer_in_trasit_warehouse_for_purchase_invoice(
		...
		from creative.accounts.doctype.sales_invoice.sales_invoice import (
			make_inter_company_purchase_invoice,
		)
		from creative.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
	...
	def test_disable_last_purchase_rate(self):
		from creative.stock.get_item_details import get_item_details
...
def prepare_data_for_internal_transfer():
	from creative.accounts.doctype.sales_invoice.test_sales_invoice import create_internal_supplier
