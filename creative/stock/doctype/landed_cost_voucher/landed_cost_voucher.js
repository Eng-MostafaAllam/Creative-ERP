...
creative.stock.LandedCostVoucher = class LandedCostVoucher extends creative.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(creative.stock.LandedCostVoucher);
