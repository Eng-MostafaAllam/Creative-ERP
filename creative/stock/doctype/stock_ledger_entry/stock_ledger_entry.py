...
from creative.controllers.item_variant import ItemTemplateCannotHaveStock
...
class StockLedgerEntry(Document):
	...
	def on_submit(self):
		...
		if not self.get("via_landed_cost_voucher"):
			from creative.stock.doctype.serial_no.serial_no import process_serial_no
	...
	def validate_and_set_fiscal_year(self):
		if not self.fiscal_year:
			...
			from creative.accounts.utils import validate_fiscal_year
	...
	def block_transactions_against_group_warehouse(self):
		from creative.stock.utils import is_group_warehouse
