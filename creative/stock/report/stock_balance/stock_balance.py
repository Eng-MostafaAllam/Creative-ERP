...
from creative.stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from creative.stock.utils import add_additional_uom_columns, is_reposting_item_valuation_in_progress
...
def execute(filters: Optional[StockBalanceFilter] = None):
	...
	if filters.get("company"):
		company_currency = creative.get_company_currency(filters.get("company"))
	else:
