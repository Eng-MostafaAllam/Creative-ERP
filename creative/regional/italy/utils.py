...
from creative.controllers.taxes_and_totals import get_itemised_tax
from creative.regional.italy import state_codes
...
def prepare_and_attach_invoice(doc, replace=False):
	...
	invoice_xml = frappe.render_template(
		"creative/regional/italy/e-invoice.xml",
