...
frappe.provide("creative.support");
...
creative.support.WarrantyClaim = class WarrantyClaim extends frappe.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new creative.support.WarrantyClaim({frm: cur_frm}));
