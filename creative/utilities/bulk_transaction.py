...
def task(doc_name, from_doctype, to_doctype):
	from creative.accounts.doctype.payment_entry import payment_entry
	from creative.accounts.doctype.purchase_invoice import purchase_invoice
	from creative.accounts.doctype.sales_invoice import sales_invoice
	from creative.buying.doctype.purchase_order import purchase_order
	from creative.buying.doctype.supplier_quotation import supplier_quotation
	from creative.selling.doctype.quotation import quotation
	from creative.selling.doctype.sales_order import sales_order
	from creative.stock.doctype.delivery_note import delivery_note
	from creative.stock.doctype.purchase_receipt import purchase_receipt
