...
import creative
from creative.accounts.doctype.bank_account.bank_account import (
...
from creative.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
from creative.accounts.doctype.tax_withholding_category.tax_withholding_category import (
	get_party_tax_withholding_details,
)
from creative.accounts.general_ledger import make_gl_entries, process_gl_map
from creative.accounts.party import get_party_account
from creative.accounts.utils import get_account_currency, get_balance_on, get_outstanding_invoices
from creative.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	def set_payment_req_status(self):
		from creative.accounts.doctype.payment_request.payment_request import update_payment_req_status
	...
	def add_party_gl_entries(self, gl_entries):
		if self.party_account:
			...
			dr_or_cr = (
				"credit" if creative.get_party_account_type(self.party_type) == "Receivable" else "debit"
			)
...
def get_reference_details(reference_doctype, reference_name, party_account_currency):
	...
	company_currency = ref_doc.get("company_currency") or creative.get_company_currency(
		ref_doc.company
	)
