...
creative.selling.POSInvoiceController = class POSInvoiceController extends creative.selling.SellingController {
	settings = {};
...
extend_cscript(cur_frm.cscript, new creative.selling.POSInvoiceController({ frm: cur_frm }))
