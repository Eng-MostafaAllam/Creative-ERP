...
class Account(NestedSet):
	...
	def autoname(self):
		from creative.accounts.utils import get_autoname_with_number

		self.name = get_autoname_with_number(self.account_number, self.account_name, self.company)

	def validate(self):
		from creative.accounts.utils import validate_field_number
				...
				doc.update(
					{
						...
						"account_currency": creative.get_company_currency(company),
