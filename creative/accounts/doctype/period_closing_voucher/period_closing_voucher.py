...
from creative.accounts.utils import get_account_currency, get_fiscal_year, validate_fiscal_year
...
def process_gl_entries(gl_entries, closing_entries, voucher_name=None):
	from creative.accounts.doctype.account_closing_balance.account_closing_balance import (
