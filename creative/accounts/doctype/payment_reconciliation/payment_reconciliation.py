...
from creative.controllers.accounts_controller import get_advance_payment_entries
...
class PaymentReconciliation(Document):
	...
	def get_jv_entries(self):
		...
		dr_or_cr = (
			...
			if creative.get_party_account_type(self.party_type) == "Receivable"
				...
				"accounts": [
					{
						...
						"cost_center": creative.get_default_cost_center(company),
					},
					{
						"account": inv.account,
						"party": inv.party,
