...
creative.accounts.PaymentReconciliationController = class PaymentReconciliationController extends frappe.ui.form.Controller {
	onload() {
...
extend_cscript(cur_frm.cscript, new creative.accounts.PaymentReconciliationController({frm: cur_frm}));
