...
from creative.controllers.sales_and_purchase_return import get_rate_for_return
from creative.controllers.stock_controller import StockController
from creative.stock.doctype.item.item import set_item_default
from creative.stock.get_item_details import get_bin_details, get_conversion_factor
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from creative.accounts.party import _get_party_details
			...
			from creative.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from creative.controllers.buying_controller import validate_item_type
