...
from creative.manufacturing.doctype.bom.bom import BOMRecursionError, item_query, make_variant_bom
from creative.manufacturing.doctype.bom_update_log.test_bom_update_log import (
...
class TestBOM(FrappeTestCase):
	...
	def test_get_items_list(self):
		from creative.manufacturing.doctype.bom.bom import get_bom_items
