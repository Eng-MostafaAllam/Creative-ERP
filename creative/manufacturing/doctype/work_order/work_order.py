...
from creative.manufacturing.doctype.bom.bom import (
	get_bom_item_rate,
	get_bom_items_as_dict,
	validate_bom_no,
)
from creative.manufacturing.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from creative.stock.doctype.batch.batch import make_batch
from creative.stock.doctype.item.item import get_item_defaults, validate_end_of_life
...
from creative.stock.stock_balance import get_planned_qty, update_bin_qty
from creative.stock.utils import get_bin, get_latest_stock_qty, validate_warehouse_company
from creative.utilities.transaction_base import validate_uom_is_integer
...
class WorkOrder(Document):
	...
	def update_work_order_qty(self):
		...
		for purpose, fieldname in (
			...
			from creative.selling.doctype.sales_order.sales_order import update_produced_qty_in_so_item
...
def make_stock_return_entry(work_order):
	from creative.stock.doctype.stock_entry.stock_entry import get_available_materials
