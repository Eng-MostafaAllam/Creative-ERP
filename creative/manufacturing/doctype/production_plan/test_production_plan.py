...
from creative.manufacturing.doctype.work_order.work_order import OverProductionError
from creative.manufacturing.doctype.work_order.work_order import make_stock_entry as make_se_from_wo
...
class TestProductionPlan(FrappeTestCase):
	...
	def test_production_plan_subassembly_default_supplier(self):
		from creative.manufacturing.doctype.bom.test_bom import create_nested_bom
