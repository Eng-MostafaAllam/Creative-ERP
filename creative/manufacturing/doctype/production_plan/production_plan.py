...
from creative.manufacturing.doctype.bom.bom import get_children as get_bom_children
from creative.manufacturing.doctype.bom.bom import validate_bom_no
from creative.manufacturing.doctype.work_order.work_order import get_item_details
from creative.setup.doctype.item_group.item_group import get_item_group_defaults
from creative.stock.get_item_details import get_conversion_factor
...
class ProductionPlan(Document):
	...
	def make_work_order(self):
		from creative.manufacturing.doctype.work_order.work_order import get_default_warehouse
...
def get_materials_from_other_locations(item, warehouses, new_mr_items, company):
	from creative.stock.doctype.pick_list.pick_list import get_available_item_locations
