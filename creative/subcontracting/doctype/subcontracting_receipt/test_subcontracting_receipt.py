...
from creative.controllers.tests.test_subcontracting_controller import (
	get_rm_items,
...
class TestSubcontractingReceipt(FrappeTestCase):
	...
	def test_subcontracting_over_receipt(self):
		...
		"""
		from creative.controllers.subcontracting_controller import (
			make_rm_stock_entry as make_subcontract_transfer_entry,
		)
		from creative.subcontracting.doctype.subcontracting_order.subcontracting_order import (
			make_subcontracting_receipt,
		)
		from creative.subcontracting.doctype.subcontracting_order.test_subcontracting_order import (
			make_subcontracted_item,
		)
	...
	def test_subcontracting_receipt_over_return(self):
		...
		from creative.controllers.status_updater import OverAllowanceError
	...
	def test_subcontracting_receipt_gl_entry(self):
		...
		self.assertEqual(cint(creative.is_perpetual_inventory_enabled(scr.company)), 1)
