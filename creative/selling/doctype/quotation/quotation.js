...
creative.selling.QuotationController = class QuotationController extends creative.selling.SellingController {
	onload(doc, dt, dn) {
	...
	get_lead_details() {
		...
		frappe.call({
			method: "creative.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(creative.selling.QuotationController);
