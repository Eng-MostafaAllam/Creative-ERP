...
from creative.controllers.accounts_controller import update_child_qty_rate
from creative.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from creative.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
	make_maintenance_visit,
)
from creative.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
from creative.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
from creative.selling.doctype.sales_order.sales_order import (
	WarehouseRequired,
	make_delivery_note,
...
class TestSalesOrder(FrappeTestCase):
	...
	def test_drop_shipping(self):
		from creative.buying.doctype.purchase_order.purchase_order import update_status
		from creative.selling.doctype.sales_order.sales_order import (
			make_purchase_order_for_default_supplier,
		)
		from creative.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_product_bundles_in_so_are_replaced_with_bundle_items_in_po(self):
		...
		"""
		from creative.selling.doctype.sales_order.sales_order import make_purchase_order
	...
	def test_make_work_order(self):
		from creative.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_serial_no_based_delivery(self):
		...
		from creative.manufacturing.doctype.production_plan.test_production_plan import make_bom
		...
		so.submit()
		from creative.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
		...
		from creative.manufacturing.doctype.work_order.work_order import (
	...
	def test_work_order_pop_up_from_sales_order(self):
		...
		from creative.controllers.item_variant import create_variant
		from creative.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from creative.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from creative.stock.doctype.material_request.material_request import raise_work_orders
	...
	def test_sales_order_partial_advance_payment(self):
		...
		from creative.selling.doctype.customer.test_customer import get_customer_dict
