...
creative.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
	constructor(opts) {
	...
	make_cards() {
		...
		chart_data.forEach((summary) => {
			let number_card = new creative.accounts.NumberCard(summary);
...
creative.accounts.NumberCard = class NumberCard {
	constructor(options) {
