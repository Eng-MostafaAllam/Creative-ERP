frappe.provide("creative.timesheet");

creative.timesheet.timer = function(frm, row, timestamp=0) {
	...
	creative.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

creative.timesheet.control_timer = function(frm, dialog, row, timestamp=0) {
