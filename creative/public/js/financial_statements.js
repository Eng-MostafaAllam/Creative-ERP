frappe.provide("creative.financial_statements");
...
creative.financial_statements = {
	...
	"formatter": function(value, row, column, data, default_formatter) {
		if (data && column.fieldname=="account") {
			...
			column.link_onclick =
				"creative.financial_statements.open_general_ledger(" + JSON.stringify(data) + ")";
			column.is_tree = true;
		}
	...
	onload: function(report) {
		...
		creative.financial_statements.filters = get_filters()
...
function get_filters() {
	let filters = [
		...
		// accordingly.
		{
			...
			"label": __("Currency"),
			"fieldtype": "Select",
			"options": creative.get_presentation_currency_list()
		},
		{
