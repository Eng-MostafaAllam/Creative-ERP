...
from creative.creative_integrations.doctype.gocardless_settings.gocardless_settings import (
...
def create_mandate(data):
	...
	if frappe.db.exists("GoCardless Mandate", mandate):
		...
		creative_customer = frappe.db.get_value(
			...
			frappe.get_doc(
				{
					...
					"mandate": mandate,
					"customer": creative_customer.customer_name,
