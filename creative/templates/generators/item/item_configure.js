class ItemConfigure {
	...
	get_next_attribute_and_values(selected_attributes) {
		return this.call('creative.e_commerce.variant_selector.utils.get_next_attribute_and_values', {
	...
	get_attributes_and_values() {
		return this.call('creative.e_commerce.variant_selector.utils.get_attributes_and_values', {
			item_code: this.item_code
		});
	}
